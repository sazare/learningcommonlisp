...
(setf (ningle:route *app* "/Users/shin/Projects/github/learningcommonlisp/play-ningle/dynamics/") "Welcome to mytest!")
...
(defun bpage (out)
  (let ((con (file-at-once "base.html")))
    (format out con) 
  )
)

(setf  (ningle:route *app* "/base" :accept '("text/html" "text/xml"))
      #'(lambda (params)
          (declare (ignore params))
          (bpage nil)
        )
