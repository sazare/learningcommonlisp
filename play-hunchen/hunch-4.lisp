...
(ql:quickload '("hunchentoot" "caveman2" "spinneret" "djula" "easy-routes" "cl-who" "html-template"))
...
(defun apage (out body)
  (format out "<html>~%<head><title>sample</title></head>~%<body>~a</body></html>" (mylist out body))
)
